        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    ...
                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#profileEdit">modifier</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        ...
                        <div class="form-group"> <input type="text" name="nom" value="<?php echo $_SESSION['nom']; ?>"
                                class="form-control" placeholder="taper votre nom">
                        </div>
                        <div class="form-group"> <input type="email" name="email"
                                value="<?php echo $_SESSION['email']; ?>" class="form-control"
                                placeholder="taper votre email ">
                        </div>
                        <div class="form-group"> <input type="password" name="mp" class="form-control"
